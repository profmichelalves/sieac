...
export function termosSituacao(periodo) {
  if (periodo === 'anual') {
    return {
      ...
      explicacaoGrafico: 'Classifica os estudantes pela frequência e pelo número de disciplinas com média anual inferior a 6,0: Aprovado (nenhuma disciplina abaixo e frequência ≥ 75%), Recuperação (1 a 6 disciplinas abaixo com frequência ≥ 75%) e Reprovado (frequência < 75% ou mais de 6 disciplinas abaixo). Estudantes sem nenhuma nota lançada aparecem na fatia "Sem Notas Lançadas".',
    };
  }
  return {
    ...
    explicacaoGrafico: 'Classifica a situação parcial dos estudantes até o momento: Em Aprovação (nenhuma disciplina com média acumulada inferior a 6,0 e frequência ≥ 75%), Em Recuperação (1 a 6 disciplinas abaixo com frequência ≥ 75%) e Em Reprovação (frequência < 75% ou mais de 6 disciplinas abaixo). Estudantes sem nenhuma nota lançada aparecem na fatia "Sem Notas Lançadas". Ao final do ano letivo, a situação é consolidada em Aprovado, Recuperação Final ou Reprovado.',
  };
}
